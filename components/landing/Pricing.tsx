    ...
    <section id="pricing" className="bg-gray-50 px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <div className="text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-pink-500">Simple Pricing</p>
          <h2 className="mt-3 text-3xl font-black text-gray-900 sm:text-4xl">Affordable Power</h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {PLANS.map((plan) => (
            ...
            >
              ...
              <p className="text-sm font-bold text-gray-500">{plan.durationEn}</p>
              <p className="mt-1 text-lg font-black text-pink-500">{plan.duration}</p>

              <p className="mt-4 text-5xl font-black text-gray-900">{plan.price}</p>
        ...
        <p className="mt-8 text-center text-sm text-gray-500">
          Pay using <strong>EVC Plus</strong>, <strong>ZAAD</strong>, or <strong>SAHAL</strong> — no cash needed.
        </p>
      </div>
    </section>
  );
