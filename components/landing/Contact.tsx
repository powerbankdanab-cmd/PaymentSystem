    ...
    <section id="contact" className="bg-white px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-pink-500">Get In Touch</p>
          <h2 className="mt-3 text-3xl font-black text-gray-900 sm:text-4xl">Contact Us</h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3">
          <div className="flex flex-col items-center rounded-2xl border border-gray-100 bg-gray-50 p-8 text-center shadow-sm transition-all hover:border-pink-200 hover:shadow-md">
            ...
            <a href="tel:+252616586503" className="mt-3 text-sm font-bold text-pink-600 hover:text-pink-700">
              +252 616 586 503
            </a>
            <a href="tel:+252616251068" className="mt-1 text-sm font-bold text-pink-600 hover:text-pink-700">
              +252 616 251 068
            </a>
          </div>
